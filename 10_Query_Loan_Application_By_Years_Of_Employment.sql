-- Loan Application, Funded Amount, Received Amount - Years of Employment
	select Employment_Years,Loan_Appln_Count_TermWise,Cast(Loan_Appln_Count_TermWise / 1000.0 as decimal(10,1)) as Loan_Appln_Count_Truncated,
		Sum(Loan_Appln_Count_TermWise) over() as Tot_Loan_Appln,
	...
	from
	(
		Select emp_length as Employment_Years, count(member_id) as Loan_Appln_Count_TermWise,
