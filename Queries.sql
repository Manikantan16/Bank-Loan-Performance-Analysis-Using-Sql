...
--MTD Loan Applications - Truncated
Select cast(count(id)/1000.0 as decimal(10,2)) as MTD_Loan_Appln_Truncated from Tbl_BankLoanData
where month(issue_date) = 12 and year(issue_date) = 2021
...
Declare @Mtd_Funded_Amt decimal(10,2),@Prev_Mtd_Funded_Amt decimal(10,2)

Select @Mtd_Funded_Amt = cast(sum(loan_amount)/1000000.0 as decimal(10,2)) from Tbl_BankLoanData where month(issue_date) = 12 and year(issue_date) = 2021
Select @Prev_Mtd_Funded_Amt = cast(sum(loan_amount)/1000000.0 as decimal(10,2)) from Tbl_BankLoanData where month(issue_date) = 11 and year(issue_date) = 2021

-- MOM_Total_Loan_Funded_Amt = ([Mtd_Funded_Amt] - [Prev_Mtd_Funded_Amt])/[Prev_Mtd_Funded_Amt]
Select cast((@Mtd_Funded_Amt  - @Prev_Mtd_Funded_Amt)/ @Prev_Mtd_Funded_Amt * 100 as decimal(10,2)) as MOM_Total_Loan_Funded_Amt
...
Declare @Mtd_Received_Amt decimal(10,2),@Prev_Mtd_Received_Amt decimal(10,2)

Select @Mtd_Received_Amt = cast(sum(total_payment)/1000000.0 as decimal(10,2)) from Tbl_BankLoanData where month(issue_date) = 12 and year(issue_date) = 2021
Select @Prev_Mtd_Received_Amt = cast(sum(total_payment)/1000000.0 as decimal(10,2)) from Tbl_BankLoanData where month(issue_date) = 11 and year(issue_date) = 2021

-- MOM_MOM_Total_Received_Amt = ([Mtd_Received_Amt] - [@Prev_Mtd_Received_Amt])/[@Prev_Mtd_Received_Amt]
Select cast((@Mtd_Received_Amt  - @Prev_Mtd_Received_Amt)/ @Prev_Mtd_Received_Amt * 100 as decimal(10,2)) as MOM_Total_Received_Amt
...
Declare @Mtd_Avg_Int_Rate decimal(10,2),@Prev_Mtd_Avg_Int_Rate decimal(10,2)

Select @Mtd_Avg_Int_Rate = cast(avg(int_rate) * 100 as decimal(10,2)) from Tbl_BankLoanData where month(issue_date) = 12 and year(issue_date) = 2021
Select @Prev_Mtd_Avg_Int_Rate = cast(avg(int_rate) * 100 as decimal(10,2)) from Tbl_BankLoanData where month(issue_date) = 11 and year(issue_date) = 2021

-- MOM_Avg_Int_Rate = ([Mtd_Avg_Int_Rate] - [Prev_Mtd_Avg_Int_Rate])/[Prev_Mtd_Avg_Int_Rate]
Select cast((@Mtd_Avg_Int_Rate  - @Prev_Mtd_Avg_Int_Rate)/ @Prev_Mtd_Avg_Int_Rate * 100 as decimal(10,2)) as MOM_Avg_Int_Rate
...
Select cast(avg(dti) * 100 as decimal(10,2)) as  Prev_MTD_Avg_DTI_Rate from Tbl_BankLoanData
where month(issue_date) = 11 and year(issue_date) = 2021

-- MoM_DTI_Rate
Declare @Mtd_DTI_Rate decimal(10,2),@Prev_Mtd_DTI_Rate decimal(10,2)

Select @Mtd_DTI_Rate = cast(avg(dti) * 100 as decimal(10,2)) from Tbl_BankLoanData where month(issue_date) = 12 and year(issue_date) = 2021
Select @Prev_Mtd_DTI_Rate = cast(avg(dti) * 100 as decimal(10,2)) from Tbl_BankLoanData where month(issue_date) = 11 and year(issue_date) = 2021

-- MoM_DTI_Rate = ([Mtd_DTI_Rate] - [Prev_Mtd_DTI_Rate])/[Prev_Mtd_DTI_Rate]
Select cast((@Mtd_DTI_Rate  - @Prev_Mtd_DTI_Rate)/ @Prev_Mtd_DTI_Rate * 100 as decimal(10,2)) as MoM_DTI_Rate
